...
namespace TheWhiteAmbit {
	...
	VideoSource::VideoSource(const wchar_t* sFileName, FrameQueue * pFrameQueue): hVideoSource_(0)
	{
		...
		CUresult oResult = cuvidCreateVideoSourceW(&hVideoSource_, sFileName, &oVideoSourceParameters);
	...
	void
		VideoSource::ReloadVideo(const wchar_t* sFileName, FrameQueue * pFrameQueue, VideoParser *pVideoParser)
	{
