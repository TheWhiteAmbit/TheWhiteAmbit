...
extern "C" 
{
    ...
    CUresult cudaLaunchNV12toARGB    (  uint32 *d_srcNV12,		uint32 nSourcePitch,	
										uint32 *d_dstARGB,		uint32 nDestPitch,
                                        uint32 width,			uint32 height		);

    CUresult cudaLaunchNV12toARGB_4pix( uint32 *d_srcNV12,		uint32 nSourcePitch,
										uint32 *d_dstARGB,		uint32 nDestPitch,
                                        uint32 width,			uint32 height		);
