...
namespace TheWhiteAmbit {
	TetrahedronBisectionB1::TetrahedronBisectionB1(Tetrahedron a_Tetrahedron, unsigned int a_iDepth)
		:ATetrahedronBisection(a_Tetrahedron, a_iDepth)
	{
	}

	TetrahedronBisectionB1::~TetrahedronBisectionB1(void)
	{
		//TODO: free bisection mem
	}

	IBisectionStrategy*	TetrahedronBisectionB1::getLeftStrategy(void)
	{
	...
	IBisectionStrategy*	TetrahedronBisectionB1::getRightStrategy(void)
	{
