...
namespace TheWhiteAmbit {
	TetrahedronBisectionC0::TetrahedronBisectionC0(Tetrahedron a_Tetrahedron, unsigned int a_iDepth)
		:ATetrahedronBisection(a_Tetrahedron, a_iDepth)
	{
	}

	TetrahedronBisectionC0::~TetrahedronBisectionC0(void)
	{
		//TODO: free bisection mem
	}

	IBisectionStrategy*	TetrahedronBisectionC0::getLeftStrategy(void)
	{
	...
	IBisectionStrategy*	TetrahedronBisectionC0::getRightStrategy(void)
	{
