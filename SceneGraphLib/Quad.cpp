...
namespace TheWhiteAmbit {
	double Quad::intersect(Ray ray)
	{
		...
		if( v < 0.0f || v > det ) //TODO: test Quad intersection: was u+v>det in Face/Triangle
			return std::numeric_limits<double>::infinity();
	...
	Matrix Quad::homography(Quad quad){
		return Matrix(); //TODO: implement this function based on homography
	}

	void Quad::findHomography(Vertex src[4], Vertex dst[4], float homography[16]){  
		//TODO: implement this function based on homography
	}  

	void Quad::gaussianElimination(float *input, int n){  
		//TODO: implement this function for gaussian elimination
	}  
}