...
namespace TheWhiteAmbit {
	...
	HexahedronBisectionV::~HexahedronBisectionV(void)
	{
		//TODO: free bisection mem
	}

	IBisectionStrategy*	HexahedronBisectionV::getLeftStrategy(void)
	{
		Hexahedron t(m_Hexahedron.v0, m_vSplitPoint0, m_Hexahedron.v2, m_vSplitPoint1, m_Hexahedron.v4, m_vSplitPoint2, m_Hexahedron.v6, m_vSplitPoint3);
		return new HexahedronBisectionH(t, m_iDepth+1);
	}

	IBisectionStrategy*	HexahedronBisectionV::getRightStrategy(void)
	{
		Hexahedron t(m_vSplitPoint0, m_Hexahedron.v1, m_vSplitPoint1, m_Hexahedron.v3, m_vSplitPoint2, m_Hexahedron.v5, m_vSplitPoint3, m_Hexahedron.v7);
		return new HexahedronBisectionH(t, m_iDepth+1);
	}
}